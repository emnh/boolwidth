...
public class BasicGraphAlgorithm {
	 ...
	 * @param all = (out union rest) P U X
	 */
	public static boolean isConnected(IndexGraph G, IVSet vs)
	{
		if(vs.isEmpty())
			return false;
	...
	public static Collection<ArrayList<IndexVertex>> connectedComponents(IndexGraph G, IVSet vs)
	{
		if(vs.isEmpty())
			return null;
