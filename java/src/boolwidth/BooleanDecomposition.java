...
public class BooleanDecomposition {
	...
	public static int getBoolWidth(IDecomposition<?, ?, ?> dc) {
		return (Integer) dc.getAttr(BOOLWIDTH_FIELD);
	}
	...
	public static void setBoolWidth(IDecomposition<?, ?, ?> dc, int bw) {
		dc.setAttr(BOOLWIDTH_FIELD, bw);
	}

	public static void setBoolWidthTime(IDecomposition<?, ?, ?> dc, int bw) {
